...
import ProjectDeviceCard from '../components/ProjectDeviceCard';
import '../css/DeviceDefinition.css'
...
const goToPreviousPage = () => {
  ...
  return (
    <div className='devicedefinition'>
      <header className='homeHeader' >
        ...
        <h1 class="title">CİHAZ TANIMLAMA</h1>
         {
